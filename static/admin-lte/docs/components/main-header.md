...
<nav class="navbar navbar-expand navbar-white navbar-light ml-0">
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item d-none d-sm-inline-block">
      <a href="{% url 'posts:home' %}" class="menu-home">Home</a>
    </li>
    <li class="nav-item d-none d-sm-inline-block">
...
<nav class="navbar navbar-expand navbar-light navbar-white">
  <div class="container">
    <a href="index3.html" class="navbar-brand">
      <img src="{{'assets/img/newsfoxn.png' | relative_url}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
...
```html
  ...
  <nav class="main-header navbar navbar-expand navbar-light navbar-white">
    <div class="container">
      <a href="index3.html" class="navbar-brand">
        <img src="dist/img/newsfoxn.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
             style="opacity: .8">
        <span class="brand-text font-weight-light">AdminLTE 3</span>
      </a>
      <!-- Left navbar links -->
